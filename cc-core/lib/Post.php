...
class Post {
    ...
    protected static $id_name = 'post_id';
    ...
    static function Create ($data) {
        ...
        Plugin::Trigger ('post.before_create');
    ...
    public function Update ($data) {
        ...
        Plugin::Trigger ('post.before_update');
