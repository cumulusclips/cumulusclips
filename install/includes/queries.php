...
('mobile_url','/cc-content/uploads/mobile'),
...
('mobile_options','-vf scale=480:-1 -vcodec libx264 x264opts level=30:cabac=0:brames=0:weightb=0:weightp=0:8x8dct=0 -b 1000k -acodec libfaac -ac 1 -ab 96k -ar 44100 -f mp4'),
