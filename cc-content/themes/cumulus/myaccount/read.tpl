...
<h1><?=Language::GetText('read_header')?></h1>
<div class="block" id="message">

    <p><a href="<?=HOST?>/myaccount/inbox/" title="<?=Language::GetText('return_inbox')?>"><?=Language::GetText('return_inbox')?></a></p>
    ...
    <a class="button" href="<?=HOST?>/myaccount/inbox/<?=$message->message_id?>/"><span><?=Language::GetText('delete')?></span></a>
